...
def get_url(search_value,search_type):
    ...
    allowed=['genus','bacdive_id','culture no','species','subspecies','sequence accession number']
    ...
    search_type_links={'genus':'https://bacdive.dsmz.de/api/bacdive/taxon/%s/'%(search_value),
                       'bacdive_id':'https://bacdive.dsmz.de/api/bacdive/bacdive_id/%s/'%(search_value.replace('/',' ')),
                       'culture no':'https://bacdive.dsmz.de/api/bacdive/culturecollectionno/%s/'%(search_value.replace('/',' ')),
